    ...
    <body id="page-top">
        ...
        <header class="masthead" style="height: 773px;">
            <div class="container">
                ...
                <a
                    class="btn btn-primary btn-xl text-uppercase js-scroll-trigger tombol"
                    href="#slider"
                    >Tell Me More</a
                >
            </div>
                ...
                <div class="row text-center">
                    <div class="col-md-6">
                        <span class="fa-4x">
                            ...
                            <img
                                src="assets/img/bestseller/redvelvet.jpg"
                                alt=""
                            />
                        </span>
                        <p class="text-muted">
                    ...
                    <div class="col-md-6">
                        <span class="fa-4x">
                            <i class="fa-stack-2x text-primary"></i>
                            <img
                                src="assets/img/bestseller/squashstrawberry.jpg"
                                alt=""
                            />
                        </span>
                        <p class="text-muted">
                    ...
                    <div class="col-md-12">
                        <span class="fa-4x">
                            <i class="fa-stack-2x text-primary"></i>
                            <img
                                src="assets/img/bestseller/signature.jpg"
                                alt=""
                            />
                        </span>
                        <p class="text-muted">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            ...
                            >
                                ...
                                <img
                                    class="img-fluid"
                                    src="assets/img/products/02-thumbnail.jpg"
                                    alt=""
                                />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            ...
                            >
                                ...
                                <img
                                    class="img-fluid"
                                    src="assets/img/products/03-thumbnail.jpg"
                                    alt=""
                                />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                        <div class="portfolio-item">
                            ...
                            >
                                ...
                                <img
                                    class="img-fluid"
                                    src="assets/img/products/04-thumbnail.jpg"
                                    alt=""
                                />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4 mb-sm-0">
                        <div class="portfolio-item">
                            ...
                            >
                                ...
                                <img
                                    class="img-fluid"
                                    src="assets/img/products/05-thumbnail.jpg"
                                    alt=""
                                />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="portfolio-item">
                            ...
                            >
                                ...
                                <img
                                    class="img-fluid"
                                    src="assets/img/products/06-thumbnail.jpg"
                                    alt=""
                                />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            ...
                            >
                                ...
                                <img
                                    class="img-fluid"
                                    src="assets/img/products/07-thumbnail.jpg"
                                    alt=""
                                />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            ...
                            >
                                ...
                                <img
                                    class="img-fluid"
                                    src="assets/img/products/08-thumbnail.jpg"
                                    alt=""
                                />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            ...
                            >
                                ...
                                <img
                                    class="img-fluid"
                                    src="assets/img/products/09-thumbnail.jpg"
                                    alt=""
                                />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                        <div class="portfolio-item">
                            ...
                            >
                                ...
                                <img
                                    class="img-fluid"
                                    src="assets/img/products/10-thumbnail.jpg"
                                    alt=""
                                />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4 mb-sm-0">
                        <div class="portfolio-item">
                            ...
                            >
                                ...
                                <img
                                    class="img-fluid"
                                    src="assets/img/products/11-thumbnail.jpg"
                                    alt=""
                                />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="portfolio-item">
                            ...
                            >
                                ...
                                <img
                                    class="img-fluid"
                                    src="assets/img/products/12-thumbnail.jpg"
                                    alt=""
                                />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            ...
                            >
                                ...
                                <img
                                    class="img-fluid"
                                    src="assets/img/products/13-thumbnail.jpg"
                                    alt=""
                                />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            ...
                            >
                                ...
                                <img
                                    class="img-fluid"
                                    src="assets/img/products/14-thumbnail.jpg"
                                    alt=""
                                />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                        <div class="portfolio-item">
                            ...
                            >
                                ...
                                <img
                                    class="img-fluid"
                                    src="assets/img/products/16-thumbnail.jpg"
                                    alt=""
                                />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                        <div class="portfolio-item">
                            <div class="portfolio-caption">
                                ...
                                <br />
                                <div
                                    class="portfolio-caption-heading1 text-center"
                                >
                                    Coming
                                </div>
                                <div
                    ...
                    <div class="container text-center">
                        <div class="row">
                            <div class="col-sm-4"> 
                                ...
                                class="fas fa-star"
                                aria-hidden="true"
                                style="color:#fed136; margin-top:20px"
                                ></i>
                                <i
                                class="fas fa-star"
                                aria-hidden="true"
                    ...
                    <li>
                        <div class="timeline-image">
                            <img
                                ...
                                src="assets/img/about/logo1.jpg"
                                alt=""
                            />
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="team-member">
                            ...
                            <a class="btn btn-dark btn-social mx-2" href="https://twitter.com/keghare" target="_blank"
                                ><i class="fab fa-twitter"></i
                            ></a>
                            <a class="btn btn-dark btn-social mx-2" href="https://web.facebook.com/kay.garland.5" target="_blank"
                                ><i class="fab fa-facebook-f"></i
                            ></a>
                            <a class="btn btn-dark btn-social mx-2" href="https://www.instagram.com/kaygarlandcreech/" target="_blank"
                    ...
                    <div class="col-lg-4">
                        <div class="team-member">
                            ...
                            <a class="btn btn-dark btn-social mx-2" href="https://twitter.com/gatorlbp" target="_blank"
                                ><i class="fab fa-twitter"></i
                            ></a>
                            <a class="btn btn-dark btn-social mx-2" href="https://web.facebook.com/Larry-parker-116321666682276/" target="_blank"
                                ><i class="fab fa-facebook-f"></i
                            ></a>
                            <a class="btn btn-dark btn-social mx-2" href="https://www.instagram.com/larryparker_/" target="_blank"
                                ><i class="fab fa-instagram"></i
                            ></a>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="team-member">
                            ...
                            <a class="btn btn-dark btn-social mx-2" href="https://twitter.com/BringelDiana" target="_blank"
                                ><i class="fab fa-twitter"></i
                            ></a>
                            <a class="btn btn-dark btn-social mx-2" href="https://web.facebook.com/diana.petersen2" target="_blank"
                                ><i class="fab fa-facebook-f"></i
                            ></a>
                            <a class="btn btn-dark btn-social mx-2" href="https://www.instagram.com/diana.petersen.739/" target="_blank"
                                ><i class="fab fa-instagram"></i
                            ></a>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                >
                    ...
                    <div class="text-center">
                        <div id="success"></div>
                        <button
                            class="btn btn-primary btn-xl text-uppercase tombol"
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 my-3 my-lg-0">
                        <a class="btn btn-dark btn-social mx-2" href="https://www.youtube.com/channel/UCOGimk62yPM_uMc6jozQl_g"
                        target="_blank" style="width:3.5rem;height:3.5rem;margin-top:-35px;"
                        ...
                        <a
                            ...
                            target="_blank" style="width:3.5rem;height:3.5rem;margin-top:-35px;"
                            ><i class="fab fa-facebook-f" style="width:25px;height:25px;"></i
                        ></a>
                    </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="modal-body">
                                    ...
                                    <br />
                                    <a href="http://localhost/home/index1.php" class="btn-lama"
                                    type="button"
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="modal-body">
                                    ...
                                    <br />
                                    <a href="http://localhost/home/index2.php" class="btn-lama"
                                    type="button"
                                    style="width: 200px; height:60px; font-size:20px">
                                        <i
                                        class="fas fa-shopping-cart mr-1"
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="modal-body">
                                    ...
                                    <br />
                                    <a href="http://localhost/home/index3.php" class="btn-lama"
                                    type="button"
                                    style="width: 200px; height:60px; font-size:20px">
                                        <i
                                        class="fas fa-shopping-cart mr-1"
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="modal-body">
                                    ...
                                    <br />
                                    <a href="http://localhost/home/index4.php" class="btn-lama"
                                    type="button"
                                    style="width: 200px; height:60px; font-size:20px">
                                        <i
                                        class="fas fa-shopping-cart mr-1"
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="modal-body">
                                    ...
                                    <br />
                                    <a href="http://localhost/home/index5.php" class="btn-lama"
                                    type="button"
                                    style="width: 200px; height:60px; font-size:20px">
                                        <i
                                        class="fas fa-shopping-cart mr-1"
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="modal-body">
                                    ...
                                    <br />
                                    <a href="http://localhost/home/index6.php" class="btn-lama"
                                    type="button"
                                    style="width: 200px; height:60px; font-size:20px">
                                        <i
                                        class="fas fa-shopping-cart mr-1"
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="modal-body">
                                    ...
                                    <br />
                                    <a href="http://localhost/home/index7.php" class="btn-lama"
                                    type="button"
                                    style="width: 200px; height:60px; font-size:20px">
                                        <i
                                        class="fas fa-shopping-cart mr-1"
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="modal-body">
                                    ...
                                    <br />
                                    <a href="http://localhost/home/index8.php" class="btn-lama"
                                    type="button"
                                    style="width: 200px; height:60px; font-size:20px">
                                        <i
                                        class="fas fa-shopping-cart mr-1"
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="modal-body">
                                    ...
                                    <br />
                                    <a href="http://localhost/home/index9.php" class="btn-lama"
                                    type="button"
                                    style="width: 200px; height:60px; font-size:20px">
                                        <i
                                        class="fas fa-shopping-cart mr-1"
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="modal-body">
                                    ...
                                    <br />
                                    <a href="http://localhost/home/index10.php" class="btn-lama"
                                    type="button"
                                    style="width: 200px; height:60px; font-size:20px">
                                        <i
                                        class="fas fa-shopping-cart mr-1"
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="modal-body">
                                    ...
                                    <br />
                                    <a href="http://localhost/home/index11.php" class="btn-lama"
                                    type="button"
                                    style="width: 200px; height:60px; font-size:20px">
                                        <i
                                        class="fas fa-shopping-cart mr-1"
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="modal-body">
                                    ...
                                    <br />
                                    <a href="http://localhost/home/index12.php" class="btn-lama"
                                    type="button"
                                    style="width: 200px; height:60px; font-size:20px">
                                        <i
                                        class="fas fa-shopping-cart mr-1"
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="modal-body">
                                    ...
                                    <br />
                                    <a href="http://localhost/home/index13.php" class="btn-lama"
                                    type="button"
                                    style="width: 200px; height:60px; font-size:20px">
                                        <i
                                        class="fas fa-shopping-cart mr-1"
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="modal-body">
                                    ...
                                    <br />
                                    <a href="http://localhost/home/index14.php" class="btn-lama"
                                    type="button"
                                    style="width: 200px; height:60px; font-size:20px">
                                        <i
                                        class="fas fa-shopping-cart mr-1"
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="modal-body">
                                    ...
                                    <br />
                                    <a href="http://localhost/home/index15.php" class="btn-lama"
                                    type="button"
                                    style="width: 200px; height:60px; font-size:20px">
                                        <i
                                        class="fas fa-shopping-cart mr-1"
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="modal-body">
                                    ...
                                    <br />
                                    <a href="http://localhost/home/index16.php" class="btn-lama"
                                    type="button"
                                    style="width: 200px; height:60px; font-size:20px">
                                        <i
                                        class="fas fa-shopping-cart mr-1"
        ...
        <script type="text/javascript">
                ...
                var medium = document.getElementById("text");
                var large = document.getElementById("text");
                //id a1 di ambil dan di tampung dalam var button1
                var button1 = document.getElementById("f1");
                //id a2 di ambil dan di tampung dalam var button2
